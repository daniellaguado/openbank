    ...
    return Form(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration:
              InputDecorations.formImputDecoration('Nome completo', null, null),
          validator: ((value) {
            String pattern =
        ...
        TextFormField(
          ...
          decoration: InputDecorations.formImputDecoration('C.P.F', null, null),
          validator: ((value) {
        ...
        MaterialButton(
            ...
            child: Container(
                ...
                child: Text(registerKey.isLoading ? 'Espere' : 'Salvar',
